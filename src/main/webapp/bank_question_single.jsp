...
<div class="card">
    ...
    <div class="card-block">
        <form action="insertQuestion.do" method="post" target="_parent">
        <div class="row">
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group" style="margin-left: 5%;">
                    <label >试题分数：</label>
                    <input type="text" class="form-control" name="questionSocre" placeholder="输入题目分值">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group row" style="margin-left: 2%;">
                    ...
                    <div class="col-md-11">
                        <textarea  name="questionTitle" rows="9" class="form-control" placeholder="Content.."></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="card-block">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>  <textarea  name="optionA" rows="9" class="form-control" ></textarea></td>
                    ...
                    <tr>
                        ...
                        <td>  <textarea  name="optionB" rows="9" class="form-control" ></textarea></td>
                    ...
                    <tr>
                        ...
                        <td>  <textarea  name="optionC" rows="9" class="form-control" ></textarea></td>
                    ...
                    <tr>
                        ...
                        <td>  <textarea  name="optionD" rows="9" class="form-control" ></textarea></td>
        ...
        <div class="card" style="margin-top: 3%;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group row" style="margin-left: 2%;">
                            ...
                            <div class="col-md-11">
                                <textarea  name="questionAnalysis" rows="9" class="form-control" placeholder="输入分析内容"></textarea>
                            </div>
                        </div>
                    </div>
                    </div>
            ...
            <div style="text-align: center">
                <button type="sumbit" class="btn btn-md btn-primary">增加</button>
