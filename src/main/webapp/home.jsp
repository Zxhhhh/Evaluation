...
<script src="index/js/modernizr-2.7.1.js"></script>
  ...
  <div class="container">
	...
	<div class="row header-info">
	  <div class="col-sm-10 col-sm-offset-1 text-center">
		<h1 class="wow fadeIn">蓝欧IT在线考评系统</h1>
		<br />
		  ...
		  <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
			<div class="row">
			  <div class="col-xs-6 text-right wow fadeInUp" data-wow-delay="1s">
				<a href="#be-the-first" class="btn btn-secondary btn-lg scroll">客户端入口</a>
			  </div>
			  <div class="col-xs-6 text-left wow fadeInUp" data-wow-delay="1.4s">
				<a href="#invite" class="btn btn-primary btn-lg scroll">发布端入口</a>
			  </div>
			</div><!--End Button Row-->  
		  </div>
		</div>
  ...
  <div class="container">
	<div class="row">
	  <div class="col-sm-8 col-sm-offset-2 text-center margin-30 wow fadeIn" data-wow-delay="0.6s">
		<h2>做最好的考评系统</h2>
		<p class="lead"><span style="color:yellow">225197</span> 考生在使用，成功提交 <span style="color:yellow">373522</span> 份试卷</p>
	  </div>
	</div>
  ...
  <div class="container">
	...
	<div class="row margin-30 news-container">
	  <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 wow fadeInLeft" data-wow-delay="0.8s">
		...
		<small><em>Tech Crunch - January 15, 2016</em></small></p>
		</a>
	  </div>
	</div>
	...
	<div class="row margin-30 news-container">
	  <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 wow fadeInLeft" data-wow-delay="1.2s">
		...
		<p class="black">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam viverra orci ut. <br /> 
		<small><em>Forbes - Feb 25, 2016</em></small></p>
		</a>
	  </div>
	</div>
