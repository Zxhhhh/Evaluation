		...
		<div class="animated fadeIn">
			...
			<div class="card">
				...
				<div class="card-block" id="examPartContentArea">
					...
					<form id="form1" class="form-horizontal" method="post" action="addMoreQuestions.do">
						
							<input type="hidden" name="bigquestion_id" value="${requestScope.bigquestion_id}" />
							
							<input type="hidden" name="paper_id" value="${requestScope.paper_id }" />
