...
<script type="text/javascript">
	$(function() {
		...
		$("#select_examType option").each(function (){
			var chooseArea = $("#chooseArea");
			if($(this).text()=="${question.questionType}"){
		...
		$("#select_examLevels option").each(function (){
			if($(this).text()=="${question.questionLevel}"){
				$(this).attr("selected",true);

			}});

		$("#select_examCatalog option").each(function (){
			if($(this).val()==${question.catalogId}){
		...
		<div class="animated fadeIn">
			...
			<div class="card">
				...
				<div class="card-block" id="examPartContentArea" >
					...
					<form class="form-horizontal" method="post" action="insertQuestion.do" target="_parent">
						...
						<div class="card">
							...
							<div class="card-block">
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										...
										<label class="form-control-label"  for="input_examScore" style="margin-left:30px">
                                         ...
                                         <input id="input_examScore" name="questionSocre" class="form-control col-md-8"  value="${question.questionSocre}" style="margin-left:100px;width:40%;display:inline-block;"/>
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
										<textarea  name="questionTitle" rows="5" class="form-control" >${question.questionTitle}</textarea>
						...
						<div class="card">
							...
							<div class="card-block">
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
										<textarea  name="questionAnalysis" rows="5" class="form-control" >${question.questionAnalysis}</textarea>
									</div>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<textarea class="form-control" rows="4" name="optionA">${question.optionA}</textarea>
											</td>
											<td>
												<c:choose>
													<c:when test="${question.answerTrue=='A'}">

														<input type="radio" class="form-control" name="answerTrue" value="A"  checked/>
										...
										<tr>
											...
											<td>
												<textarea class="form-control" rows="4" name="optionB">${question.optionB}</textarea>
											</td>
											<td>
												<c:choose>
													<c:when test="${question.answerTrue=='B'}">

														<input type="radio" class="form-control" name="answerTrue" value="B"  checked/>
										...
										<tr>
											...
											<td>
												<textarea class="form-control" rows="4" name="optionC">${question.optionC}</textarea>
											</td>
											<td>
												<c:choose>
													<c:when test="${question.answerTrue=='C'}">

														<input type="radio" class="form-control" name="answerTrue" value="C"  checked/>
										...
										<tr>
											...
											<td>
												<textarea class="form-control" rows="4" name="optionD">${question.optionD}</textarea>
											</td>
											<td>
												<c:choose>
													<c:when test="${question.answerTrue=='D'}">

														<input type="radio" class="form-control" name="answerTrue" value="D"  checked/>
							...
							<div class="card-block">
								...
								<div class="form-group row">
									...
									<label class="radio-inline col-md-6" for="inline-radio1" >
										<c:choose>
											<c:when test="${question.answerTrue=='true'}">

												<input id="inline-radio1" name="answerTrue" value="true" type="radio" style="margin-left:250px" checked>
												正确
                                    ...
                                    <label class="radio-inline col-md-6" for="inline-radio2">
										<c:choose>
											<c:when test="${question.answerTrue=='false'}">

												<input id="inline-radio2" name="answerTrue" value="false" type="radio" checked>
												错误
							...
							<div class="card-header">
								...
								<div class="card-block">
									...
									<div class="form-group row">
										...
										<div class="col-md-9">
											<textarea  name="answerTrue" rows="5" class="form-control" ></textarea>
										</div>
